...
11. The worker still does **not** claim supervised workers, real fetch/import/reindex execution beyond the local-Git preflight plus persisted revision/content-count/current-branch baseline, broad durable worker metadata, retries, scheduling, or continuous background orchestration.
