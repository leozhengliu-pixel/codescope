...
11. The worker still does **not** claim supervised workers, real fetch/import/reindex execution beyond the local-Git preflight plus revision/content-discovery/current-branch baseline, durable worker metadata, retries, scheduling, or continuous background orchestration.
