...
| --- | --- | --- | --- |
| Health, readiness, and public config | `/healthz`, `/readyz`, `/api/v1/config` | Operator-visible service liveness, bounded metadata readiness, and frontend bootstrap config parity | `specs/acceptance/operator-runtime.md` |
